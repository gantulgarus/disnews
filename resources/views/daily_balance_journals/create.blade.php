...
@section('content')
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h2 class="h5 mb-0">Тооцооны журнал бүртгэл</h2>
        ...
        <form action="{{ route('daily-balance-journals.store') }}" method="POST" class="compact-form">
            @csrf
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="dispatcher_name" class="form-control form-control-sm"
                                    value="{{ old('dispatcher_name') }}" required>
                            </div>
                        </div>
                    </div>
                </div>
