    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item {{ request()->routeIs('power-plants.index') ? 'active' : '' }}">
                    <a class="nav-link {{ request()->routeIs('power-plants.index') ? 'active' : '' }}"
                ...
                <li class="nav-item {{ request()->routeIs('power-plant-daily-reports.index') ? 'active' : '' }}">
                    <a class="nav-link {{ request()->routeIs('power-plant-daily-reports.index') ? 'active' : '' }}"
                ...
                <li class="nav-item {{ request()->routeIs('daily-balance-journals.index') ? 'active' : '' }}">
                    <a class="nav-link {{ request()->routeIs('daily-balance-journals.index') ? 'active' : '' }}"
