    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown {{ $isOperationActive ? 'show active' : '' }}">
                    <a class="nav-link dropdown-toggle {{ $isOperationActive ? 'active' : '' }}" href="#navbar-base"
                        data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="{{ $isOperationActive ? 'true' : 'false' }}">
