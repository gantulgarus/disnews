...
<body>
    ...
    <!-- Tabler Core -->
    <script src="{{ asset('assets/dist/js/tabler.min.js?1692870487') }}"></script>
    <script src="{{ asset('assets/dist/js/demo.min.js?1692870487') }}"></script>
    ...
    <!-- Libs JS -->
    <script src="{{ asset('assets/dist/libs/apexcharts/dist/apexcharts.min.js?1692870487') }}"></script>
    <script src="{{ asset('assets/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1692870487') }}"></script>
    <script src="{{ asset('assets/dist/libs/jsvectormap/dist/maps/world.js?1692870487') }}"></script>
    <script src="{{ asset('assets/dist/libs/jsvectormap/dist/maps/world-merc.js?1692870487') }}"></script>
